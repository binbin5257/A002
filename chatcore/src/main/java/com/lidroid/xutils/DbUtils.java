...
public class DbUtils {
    ...
    public synchronized void save(Object entity) throws DbException {
        try {
            beginTransaction();
    ...
    public synchronized boolean saveBindingId(Object entity) throws DbException {
    ...
    public synchronized void update(Object entity, String... updateColumnNames) throws DbException {
        if (!tableIsExist(entity.getClass())) return;
        try {
            beginTransaction();
