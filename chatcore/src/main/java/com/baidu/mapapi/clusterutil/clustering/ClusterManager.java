...
public class ClusterManager<T extends ClusterItem> implements
    ...
    private MyCluterMapstatueChangeLisener myCluterMapstatueChangeLisener;
    ...
    public void onMapStatusChangeStart(MapStatus mapStatus) {
        ...
        //实现回调
        if(myCluterMapstatueChangeLisener != null) {
            myCluterMapstatueChangeLisener.onMapStatusChangeStart(mapStatus);
        }
    }
    ...
    public void onMapStatusChange(MapStatus mapStatus) {
        ...
        //实现回调
        if(myCluterMapstatueChangeLisener != null) {
            myCluterMapstatueChangeLisener.onMapStatusChange(mapStatus);
        }
    ...
    public void onMapStatusChangeFinish(MapStatus mapStatus) {
        //实现回调
        if(myCluterMapstatueChangeLisener != null) {
            myCluterMapstatueChangeLisener.onMapStatusChangeFinish(mapStatus);
        }
    }
...
//        return false;
    ...
    public void setMyCluterMapstatueChangeLisener(MyCluterMapstatueChangeLisener myCluterMapstatueChangeLisener) {
        this.myCluterMapstatueChangeLisener = myCluterMapstatueChangeLisener;
    }
}
