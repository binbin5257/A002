package cn.lds.chatcore.common.pickerview;
...
public class TimeDataModel {
    ...
    public static void initData(ArrayList<ProvinceBean> options1Items, ArrayList<ArrayList<String>> options2Items, ArrayList<ArrayList<ArrayList<String>>> options3Items) {
        ...
        }else{//   2017/9/18/17:40
            options1Items.add(new ProvinceBean(0, "今天", curYear + "/"+ curMonth + "/"+ curDay + "/",""));
            options1Items.add(new ProvinceBean(1, "明天", curYear + "/"+ curMonth + "/"+ (curDay+1) + "/",""));
            options1Items.add(new ProvinceBean(2,  curYear + "年"+ curMonth + "月"+ (curDay+1) + "日", curYear + "/"+ curMonth + "/"+ (curDay+1) + "/", ""));
                ...
                if(options2Items_01L == 0){
                    if(curMin > 40 && curMin < 50){
                        for(int x = 0; x < 60; x += 10){
                            if(x == 0){
                                options3Items_01_01LL.add(x + "0分");
                            }else{
                        ...
                        for(int k = 0; k < 60; k += 10){
                            if(curMin + 10 > 60){
                                if( k > curMin + 10 -60){
                                    if(k == 0){
                                        options3Items_01_01LL.add(k + "0分");
                                    }else{
