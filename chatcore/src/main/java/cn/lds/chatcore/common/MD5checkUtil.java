...
public class MD5checkUtil {
    ...
    private static MD5checkUtil instance = null;

    public static MD5checkUtil getInstance() {
        instance = new MD5checkUtil();
        try {
    ...
    public String getFileMD5StringByInputStream(InputStream file) throws IOException {
        byte[] buffer = new byte[1024];
        int numRead = 0;
