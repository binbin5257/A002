...
import cn.lds.chatcore.view.dialog.callback.OnDialogOnItemClickListener;
import cn.lds.chatcore.view.dialog.callback.SimpleOnKeyListener;
import cn.lds.chatcore.view.dialog.helper.OnClickHelper;
import cn.lds.chatcore.view.dialog.util.StatusBarUtils;
...
public abstract class BaseDialog<D extends BaseDialog> extends Dialog implements View.OnClickListener {
    ...
    public OnDialogOnItemClickListener onDialogOnItemClickListener;
     ...
     * 设置list条目点击监听器
     */
    public D setOnDialogOnItemClickListener(OnDialogOnItemClickListener onDialogOnItemClickListener) {
        this.onDialogOnItemClickListener = onDialogOnItemClickListener;
        return (D) this;
    }
    ...
    public void destody() {
        ...
        onDialogOnItemClickListener = null;
    }
    ...
    public void onDialogListClickListener(int position) {
        if (onDialogOnItemClickListener != null) {
            onDialogOnItemClickListener.onDialogItemClick((D) this, position);
        }
    }
