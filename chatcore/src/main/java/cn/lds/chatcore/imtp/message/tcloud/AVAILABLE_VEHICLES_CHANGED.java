...
public class AVAILABLE_VEHICLES_CHANGED extends TcloudMessage {

    public MsgType getType() {
        return MsgType.AVAILABLE_VEHICLES_CHANGED;
    }
...
//			return;
        try {
            ...
            setMessageType(MsgType.AVAILABLE_VEHICLES_CHANGED.name());
