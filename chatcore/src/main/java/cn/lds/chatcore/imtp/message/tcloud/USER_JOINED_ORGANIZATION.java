...
public class USER_JOINED_ORGANIZATION extends TcloudMessage {



    public MsgType getType() {
        return MsgType.USER_JOINED_ORGANIZATION;
    }
    @Override
...
//			return;
        try {
            ...
            setMessageType(MsgType.USER_JOINED_ORGANIZATION.name());
