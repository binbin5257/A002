...
public class USER_RELEASED_ORGANIZATION extends TcloudMessage {



    public MsgType getType() {
        return MsgType.USER_RELEASED_ORGANIZATION;
    }
    @Override
...
//			return;
        try {
            ...
            setMessageType(MsgType.USER_RELEASED_ORGANIZATION.name());
