...
package cn.lds.im.common.zxing.camera;
...
public final class CameraManager {
    ...
    // private static final int MIN_FRAME_WIDTH_DIP = 120;
    // private static final int MIN_FRAME_HEIGHT_DIP = 120;
    private static final int MAX_FRAME_WIDTH_DIP = 254;
    private static final int MAX_FRAME_HEIGHT_DIP = 254;
    ...
    private CameraManager(Context context) {
        ...
        // MIN_FRAME_WIDTH = (int) (MIN_FRAME_WIDTH_DIP * density);
        // MIN_FRAME_HEIGHT = (int) (MIN_FRAME_HEIGHT_DIP * density);
        MAX_FRAME_WIDTH = (int) (MAX_FRAME_WIDTH_DIP * density);
        MAX_FRAME_HEIGHT = (int) (MAX_FRAME_HEIGHT_DIP * density);
    }
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null) {
            ...
            if (null == screenResolution) {
                ToolsHelper.showStatus(context, false, context.getString(R.string.cameramanager_opencamrea));
                return null;
            }
            int leftOffset = (screenResolution.x - width) / 2;
            int topOffset = (screenResolution.y - height) / 2;
