...
package cn.lds.im.common.CordovaPlugin.WhitelistPlugin;
...
public class WhitelistPlugin extends CordovaPlugin {
    static String TAG = "WhitelistPlugin";
    String calls = "";
    ...
    public WhitelistPlugin(Whitelist allowedNavigations, Whitelist allowedIntents, Whitelist allowedRequests) {
        ...
        LOG.d(TAG, "WhitelistPlugin(Whitelist allowedNavigations, Whitelist allowedIntents, Whitelist allowedRequests)");
    }
    ...
    private class CustomConfigXmlParser extends ConfigXmlParser {
        ...
        public void handleStartTag(XmlPullParser xml) {
            ...
            if (strNode.equals("content")) {
                ...
                if (origin != null) {
                    if (external) {
                        Log.w(TAG, "Found <access launch-external> within config.xml. Please use <allow-intent> instead.");
