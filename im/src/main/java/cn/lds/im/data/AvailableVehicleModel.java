...
public class AvailableVehicleModel {
    ...
    /**
     * status : success
     * data : [{"brandName":"string","chargingRule":"string","configuration":"string","id":0,"maxSustainedMileage":0,"pictureId":"string","seriesName":"string","year":0}]
     * errors : [{"field":"string","errmsg":"string","errcode":"string"}]
     * timestamp : 2017-07-13T07:57:55.531Z
     */
