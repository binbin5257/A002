...
import cn.lds.im.view.widget.pullToRefreshView.internal.EmptyViewMethodAccessor;
import cn.lds.im.view.widget.pullToRefreshView.internal.IndicatorLayout;
...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView>
	...
	protected void addRefreshableView(Context context, T refreshableView) {
		...
		mRefreshableViewHolder.addView(refreshableView,
				ViewGroup.LayoutParams.FILL_PARENT,
				ViewGroup.LayoutParams.FILL_PARENT);
		addViewInternal(mRefreshableViewHolder, new LinearLayout.LayoutParams(
