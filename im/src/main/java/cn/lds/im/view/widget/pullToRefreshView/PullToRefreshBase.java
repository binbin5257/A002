...
import cn.lds.im.view.widget.pullToRefreshView.internal.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	protected void addRefreshableView(Context context, T refreshableView) {
		addViewInternal(refreshableView, new LayoutParams(
	...
	protected void updateUIForMode() {
		...
		if (mMode.canPullDown()) {
			addViewInternal(mHeaderLayout, 0, new LayoutParams(
		...
		if (mMode.canPullUp()) {
			addViewInternal(mFooterLayout, new LayoutParams(
					ViewGroup.LayoutParams.FILL_PARENT,
					ViewGroup.LayoutParams.WRAP_CONTENT));
		}
