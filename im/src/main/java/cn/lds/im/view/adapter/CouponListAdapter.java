...
public class CouponListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            holder.coupon_rly = (RelativeLayout) convertView.findViewById(R.id.coupon_rly);
...
//            holder.useBtn = (Button) convertView.findViewById(R.id.btn_use);
            holder.priceIc = (TextView) convertView.findViewById(R.id.ic_price);
...
//                    holder.useBtn.setTextColor(mContext.getResources().getColor(R.color.coupon_color));
                holder.coupon_rly.setBackgroundResource(R.drawable.bg_coupon_blue);
//                holder.coupon_amount.setTextColor(mContext.getResources().getColor(R.color.coupon_color));
//                holder.priceIc.setTextColor(mContext.getResources().getColor(R.color.coupon_color));
                break;
            case  CouponStatus.USED:
//                    holder.useBtn.setText(CouponStatusEnum.valueOf(status).value());
//                    holder.useBtn.setBackgroundResource(R.drawable.bg_coupon_use_not);
//                    holder.useBtn.setTextColor(mContext.getResources().getColor(R.color.coupon_remind));
                holder.coupon_rly.setBackgroundResource(R.drawable.bg_coupon_gray);
//                holder.coupon_amount.setTextColor(mContext.getResources().getColor(R.color.coupon_remind));
//                holder.priceIc.setTextColor(mContext.getResources().getColor(R.color.coupon_remind));
//                holder.useBtn.setClickable(false);
                break;
...
//        if(ToolsHelper.isNull(dataBean.getPrice())){
//            holder.coupon_amount.setText("");
//        }else {
//            holder.coupon_amount.setText(df.format(ToolsHelper.stringTOdouble(dataBean.getPrice())/100) + "");
//        }
