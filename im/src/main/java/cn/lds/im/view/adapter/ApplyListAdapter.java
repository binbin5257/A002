...
public class ApplyListAdapter extends BaseAdapter{
    ...
    private List<ApplyListModel.DataBean> mList;
    private Context mContext;
    private final LayoutInflater inflater;

    public ApplyListAdapter(Context context, List<ApplyListModel.DataBean> list) {
        this.mList = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ApplyListModel.DataBean dataBean = mList.get(position);
        ...
        holder.time.setText(TimeHelper.getTimeFromMillis(TimeHelper.FORMAT11, Long.parseLong(dataBean.getUserDate()))
                ...
                + "~"+TimeHelper.getTimeFromMillis(TimeHelper.FORMAT2, dataBean.getEndTime()));
