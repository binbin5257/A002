...
public class DashedLineView extends View {
    private static final String TAG = "DashedLineView";
    ...
    public DashedLineView(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs,R.styleable.DashedLineView);
        dashWidth = typedArray.getDimension(R.styleable.DashedLineView_dashWidth,DEFAULT_DASH_WIDTH);
        lineHeight = typedArray.getDimension(R.styleable.DashedLineView_dashlineHeight, DEFAULT_LINE_HEIGHT);
        lineWidth = typedArray.getDimension(R.styleable.DashedLineView_dashlineWidth, DEFAULT_LINE_WIDTH);
        lineColor = typedArray.getColor(R.styleable.DashedLineView_dashlineColor, DEFAULT_LINE_COLOR);
        dashOrientation = typedArray.getInteger(R.styleable.DashedLineView_dashOrientation,DEFAULT_DASH_ORIENTATION);
