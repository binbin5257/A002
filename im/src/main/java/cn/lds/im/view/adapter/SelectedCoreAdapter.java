 ...
 * 码表选择器适配器
 */
public class SelectedCoreAdapter extends BaseAdapter {
    ...
    public SelectedCoreAdapter(Context context, ArrayList<PopSelectedModel> popSelectedModels) {
        mContext = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        itemHolder.nameTx.setText(popSelectedModel.getMasterTable().getText());
