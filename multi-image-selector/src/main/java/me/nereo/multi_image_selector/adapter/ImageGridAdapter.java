...
import cn.lds.chatcore.common.MyVideoThumbLoader;
...
public class ImageGridAdapter extends BaseAdapter {
    ...
    ImageLoaderHelper imageLoaderHelperder;
...
//                    displayConfig.setBitmapMaxSize(new BitmapSize(mGridWidth, mGridWidth));
//                    BitmapHelper.getBitmapUtils(null).display(image, data.path, displayConfig);
                } else {
                    image.setImageResource(R.drawable.default_error);
                    //重点代码
                    image.setTag(data.path);//绑定imageview
                    mVideoThumbLoader.showThumbByAsynctack(data.path, image, mGridWidth, mGridWidth);
//                    imageLoaderHelperder.DisplayImage(data.id, 1, image);
